...
Use:
- [Analysis/official_trade_quality_report.py](Analysis/official_trade_quality_report.py)
- [Analysis/official_diag_report.py](Analysis/official_diag_report.py) when a probe emits `DIAG` events
- [Analysis/v52_monte_carlo_robustness.py](Analysis/v52_monte_carlo_robustness.py) for local robustness checks
- [Analysis/monte_carlo_sensitivity_report.py](Analysis/monte_carlo_sensitivity_report.py) for postmortem analysis
