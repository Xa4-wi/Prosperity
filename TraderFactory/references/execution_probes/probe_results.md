...
- [Traderv55.py](Research/execution_probes/bots/Traderv55.py)
...
- [Traderv56.py](Research/execution_probes/bots/Traderv56.py)
...
- the missing `lp_summary` is partly explained by a real bug:
  [Traderv56.py](Research/execution_probes/bots/Traderv56.py) used `PROBE_ROUND_LENGTH = 1_000_000.0`, so the end summary threshold never triggered in the official `0-199900` timestamp window
...
- [Traderv57.py](Research/execution_probes/bots/Traderv57.py)
- [official_aggressive_markout_probe_report.py](Research/execution_probes/tools/official_aggressive_markout_probe_report.py)

Official outcome:

- [reports/v57_aggressive_markout_probe_summary.txt](Research/execution_probes/reports/v57_aggressive_markout_probe_summary.txt)
- [reports/v52_vs_v57_official_trade_quality_report.md](Research/execution_probes/reports/v52_vs_v57_official_trade_quality_report.md)
...
- [Traderv58.py](Research/execution_probes/bots/Traderv58.py)
- [official_aggressive_markout_probe_report.py](Research/execution_probes/tools/official_aggressive_markout_probe_report.py)

Official outcome:

- [reports/v58_aggressive_markout_probe_summary.txt](Research/execution_probes/reports/v58_aggressive_markout_probe_summary.txt)
- [reports/v52_vs_v58_official_trade_quality_report.md](Research/execution_probes/reports/v52_vs_v58_official_trade_quality_report.md)
...
- [Traderv59.py](Research/execution_probes/bots/Traderv59.py)
- [official_aggressive_markout_probe_report.py](Research/execution_probes/tools/official_aggressive_markout_probe_report.py)

Official outcome:

- [reports/v59_aggressive_markout_probe_summary.txt](Research/execution_probes/reports/v59_aggressive_markout_probe_summary.txt)
- [reports/v52_vs_v59_official_trade_quality_report.md](Research/execution_probes/reports/v52_vs_v59_official_trade_quality_report.md)
