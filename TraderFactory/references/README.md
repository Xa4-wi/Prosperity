...
This folder contains copied or indexed source material from the current project history.

It exists so that `TraderFactory` does not depend entirely on chat memory or on developers knowing where the old repos hid important ideas.
