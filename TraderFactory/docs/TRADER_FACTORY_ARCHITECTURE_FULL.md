...
- for the current implemented state, treat [README.md](TraderFactory/README.md) and [docs/ENGINES.md](TraderFactory/docs/ENGINES.md) as the authoritative status documents
- for the milestone path from current state to full autonomy, treat [docs/AUTONOMY_CHECKLIST.md](TraderFactory/docs/AUTONOMY_CHECKLIST.md) as the working checklist
