...
The legacy sibling path is only a fallback for convenience. The intended standalone home for replay data is [data/README.md](TraderFactory/data/README.md).
...
- [trader_factory/simulation/deterministic.py](TraderFactory/trader_factory/simulation/deterministic.py)
- [trader_factory/simulation/internal_backtest.py](TraderFactory/trader_factory/simulation/internal_backtest.py)
- [trader_factory/core/datamodel.py](TraderFactory/trader_factory/core/datamodel.py)
...
- replay through [Traderv52.py](Bots/Traderv52.py)
...
- [trader_factory/optimization/cmaes.py](TraderFactory/trader_factory/optimization/cmaes.py)
...
- [trader_factory/simulation/monte_carlo.py](TraderFactory/trader_factory/simulation/monte_carlo.py)
...
- a reduced paired run comparing [Traderv52.py](Bots/Traderv52.py) vs [Traderv51.py](Bots/Traderv51.py)
...
- [trader_factory/diagnostics/official.py](TraderFactory/trader_factory/diagnostics/official.py)
- [trader_factory/diagnostics/trade_quality.py](TraderFactory/trader_factory/diagnostics/trade_quality.py)
- [trader_factory/diagnostics/boundary_probe.py](TraderFactory/trader_factory/diagnostics/boundary_probe.py)
- [trader_factory/diagnostics/passive_ladder.py](TraderFactory/trader_factory/diagnostics/passive_ladder.py)
- [trader_factory/diagnostics/aggressive_markout.py](TraderFactory/trader_factory/diagnostics/aggressive_markout.py)
...
- [trader_factory/probes/specs.py](TraderFactory/trader_factory/probes/specs.py)
- [trader_factory/probes/logging.py](TraderFactory/trader_factory/probes/logging.py)
- [trader_factory/probes/scaffold.py](TraderFactory/trader_factory/probes/scaffold.py)
...
- [trader_factory/generation/project.py](TraderFactory/trader_factory/generation/project.py)
