...
DEFAULT_IPR_PARAMS = {
    ...
    "RESIDUAL_ALPHA": 0.1076020145,          # EMA alpha for residual tracking
    "SPREAD_ALPHA": 0.08,            # EMA alpha for spread tracking
    "LOOKAHEAD_BONUS": 5.0378144093,          # constant upward bias in fair value
    # Position targeting
    "BASE_CARRY": 6.8355342194,              # always want at least this many units
    "EARLY_LONG_BIAS": 42.2280437122,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.47415498,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 8.0,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.4456780887,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.7991053656,
    "BASE_QUOTE_EDGE": 5.3388819756,
    "SOFT_LIMIT": 52,
    ...
    "CHEAP_ACCUM_END": 0.5658780444,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.1093308529,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.4898351598,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5587541527,
    "CHEAP_ACCUM_TARGET_BUFFER": 19.3380233334,
}
