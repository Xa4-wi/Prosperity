...
class AshCoatedOsmiumBot:
    ...
    MID_WEIGHT = 0.12
    INVENTORY_SKEW = 0.0819699795
    DEFAULT_EDGE = 7.9466591537
    JOIN_EDGE = 2.0
    BASE_ORDER_SIZE = 12
    SOFT_LIMIT = 28
    TAKE_LEVELS = (
...
class IntarianPepperRootBot:
    DRIFT_PER_TIMESTAMP = 0.0011402092
    RESIDUAL_ALPHA = 0.1106262131
    SPREAD_ALPHA = 0.08
    BASE_CARRY = 8.2438876884
    EDGE_TARGET_SCALE = 9.6534076922
    ZSCORE_BUY_BONUS = 9.6964844619
    ZSCORE_SELL_PENALTY = 10.372821053
    MAX_LONG_TARGET = 56
    MAX_SHORT_TARGET = 24
    INVENTORY_SKEW = 0.1035318166
    BASE_TAKE_EDGE = 1.2423622795
    BASE_QUOTE_EDGE = 3.0661455259
    SOFT_LIMIT = 45
    PASSIVE_SIZE = 10
    MAX_TAKE_SIZE = 14
    BULLISH_IMBALANCE = 0.0717313126
    OVEREXTENSION_Z = 0.9121418651
