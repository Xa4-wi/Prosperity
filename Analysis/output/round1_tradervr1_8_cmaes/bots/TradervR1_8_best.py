...
class AshCoatedOsmiumBot:
    ...
    IMBALANCE_FAIR_WEIGHT = 3.42562517
    MICRO_FAIR_WEIGHT = 0.35
    INVENTORY_SKEW = 0.0962669343
    BASE_EDGE = 6.9631931556
    JOIN_EDGE = 2.0
    FRONT_ORDER_SIZE = 8
    BACK_ORDER_SIZE = 5
    SOFT_LIMIT = 28
...
class IntarianPepperRootBot:
    DRIFT_PER_TIMESTAMP = 0.0010186903
    RESIDUAL_ALPHA = 0.1045850442
    SPREAD_ALPHA = 0.08
    BASE_CARRY = 12.290586011615789
    EARLY_LONG_BIAS = 31.4678416111
    EDGE_TARGET_SCALE = 11.92823771443657
    ZSCORE_BUY_BONUS = 12.0
    ZSCORE_SELL_PENALTY = 9.0521286277
    MAX_LONG_TARGET = 68
    MAX_SHORT_TARGET = 20
    INVENTORY_SKEW = 0.0817715429
    BASE_TAKE_EDGE = 1.0871313705
    BASE_QUOTE_EDGE = 2.4597842345
    SOFT_LIMIT = 52
    PASSIVE_FRONT_SIZE = 9
    PASSIVE_BACK_SIZE = 6
    MAX_TAKE_SIZE = 16
    BULLISH_IMBALANCE = 0.0356698423
    OVEREXTENSION_Z = 1.1854741008
    EARLY_ACCUM_END = 0.42
    LOOKAHEAD_BONUS = 4.0867956796
    PASSIVE_BUY_BUFFER = 18
    PASSIVE_SELL_BUFFER = 7.8100826736
