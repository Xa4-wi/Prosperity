...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 41.7685309247,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 6.7448474133,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.7314589103,
    "BASE_QUOTE_EDGE": 5.9607120182,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.200336128,
    "BULLISH_IMBALANCE": 0.0794796925,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.5368314382,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0550021525,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.1715305857,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.3744905904,
