...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.5280772225,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.8361300446,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.6005227257,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 62.0583007946,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 0.9644844243,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.5088200958,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.7415528948,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1684891205,
    "STRONG_IMBALANCE": 0.1053614435,
}
