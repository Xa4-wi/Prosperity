...
### TradervR1_lab_r14_05_p_entry_quality_a_quality_guard

- Parent: `TradervR1_lab_r13_05_a_quality_guard`
...
### TradervR1_lab_r14_02_a_quality_guard
...
- Composite score: `-376.6528`
- MC plausible mean delta: `320.4167`
- MC plausible p10 delta: `-4244.5000`
- MC win rate: `0.8333`

## Family Weight Update

- ash_attack_tuning: mean_score=-842.89 old=0.181 new=0.2
- ash_quality_guard: mean_score=-464.75 old=0.181 new=0.2
- ash_local_fair_blend: mean_score=-781.78 old=0.209 new=0.2
- pepper_entry_quality: mean_score=-116.56 old=0.235 new=0.223
- pepper_carry_defense: mean_score=-479.48 old=0.194 new=0.2
