...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 1.4550754396,           # default passive quote edge
    "JOIN_EDGE": 1.9806898342,           # snap quote to existing order when within this
    "FRONT_SIZE": 19.7600762489,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 67.1166300123,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 1.808621715,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 6.1233876843,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 9.9614673605,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2367807458,
    "STRONG_IMBALANCE": 0.1106857963,
}
