...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.4625423675,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.9662443545,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.6005227257,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 62.0583007946,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 2.2139255965,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.4191388107,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 5.7647821129,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
