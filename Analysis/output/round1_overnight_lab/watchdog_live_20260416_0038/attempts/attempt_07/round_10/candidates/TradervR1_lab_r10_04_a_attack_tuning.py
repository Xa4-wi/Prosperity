...
DEFAULT_ASH_PARAMS = {
    ...
    "BASE_EDGE": -0.5497649241,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0439439361,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.636344172,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.6917751844,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.5793166129,
    "MIN_QUOTE_EDGE": 3.291036845,
    "TAKE_L3_SIZE": 16,
