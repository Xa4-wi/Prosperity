...
DEFAULT_ASH_PARAMS = {
    ...
    "BASE_EDGE": -0.0462239797,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.3065710391,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.2755769913,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.310882512,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.6406451169,
    "MIN_QUOTE_EDGE": 4.5276601574,
    "TAKE_L3_SIZE": 16,
...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.496389288,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0170475189,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.4477712336,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5482736697,
