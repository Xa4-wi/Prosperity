...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.3619504004,
    "STABLE_MID_WEIGHT": 0.6380495996,
    "WALL_MID_BLEND": 0.4435774816,
    "LOCAL_MICRO_WEIGHT": 0.3768296772,
    "LOCAL_IMBALANCE_BIAS": 0.1706962103,
    "DEPTH_IMPACT_SCALE": 50.2211312163,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.091807475,
    "INVENTORY_CURVE": 1.68988618,
    "BASE_EDGE": 2.5,           # default passive quote edge
    "JOIN_EDGE": 1.7874167542,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 1.2325229455,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 6.5,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 8.6501134314,
    "TAKE_L3_SIZE": 16,
