...
DEFAULT_ASH_PARAMS = {
    ...
    "FRONT_SIZE": 17.8041533252,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 65.28392878,           # reduce aggressiveness above this inventory
    ...
    "ADVERSE_IMBALANCE": 0.1646754697,
    "STRONG_IMBALANCE": 0.08,
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 46.9150419163,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 6.794775595,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.7055408698,
    "BASE_QUOTE_EDGE": 4.5563642871,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 0.8724095953,
    "BULLISH_IMBALANCE": 0.0474960579,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.5360553894,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.2049219512,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.3389477815,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -1.0313560586,
    "CHEAP_ACCUM_TARGET_BUFFER": 17,
}
