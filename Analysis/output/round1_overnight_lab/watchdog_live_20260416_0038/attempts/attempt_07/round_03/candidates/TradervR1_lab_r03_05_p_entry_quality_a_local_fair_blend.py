...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.3301921634,
    "STABLE_MID_WEIGHT": 0.6698078366,
    "WALL_MID_BLEND": 0.2328221332,
    "LOCAL_MICRO_WEIGHT": 0.5715959918,
    "LOCAL_IMBALANCE_BIAS": 0.1579049079,
    "DEPTH_IMPACT_SCALE": 84.7151404292,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1373864276,
    "INVENTORY_CURVE": 3.1897183739,
    "BASE_EDGE": -0.6575482573,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.0,           # snap quote to existing order when within this
    "FRONT_SIZE": 22.0,
    "BACK_SIZE": 8,
    "SOFT_LIMIT": 55.7480755504,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 1.8784812024,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.5,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.1203268858,
    "MIN_QUOTE_EDGE": 2.1474634552,
    "TAKE_L3_SIZE": 16,
...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.5597316183,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0400312069,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.3930482456,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5213497449,
    "CHEAP_ACCUM_TARGET_BUFFER": 28,
}
