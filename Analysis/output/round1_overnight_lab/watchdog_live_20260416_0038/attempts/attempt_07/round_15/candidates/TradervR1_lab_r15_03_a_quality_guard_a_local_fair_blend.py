...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.3398411758,
    "STABLE_MID_WEIGHT": 0.6601588242,
    "WALL_MID_BLEND": 0.1939608591,
    "LOCAL_MICRO_WEIGHT": 0.3544929747,
    "LOCAL_IMBALANCE_BIAS": 0.1353576138,
    "DEPTH_IMPACT_SCALE": 31.4302849296,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1026744278,
    "INVENTORY_CURVE": 2.3568599608,
    "BASE_EDGE": -1.0,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.3666275776,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 64.428330064,           # reduce aggressiveness above this inventory
    ...
    "ADVERSE_IMBALANCE": 0.1705968384,
    "STRONG_IMBALANCE": 0.1626462751,
}
