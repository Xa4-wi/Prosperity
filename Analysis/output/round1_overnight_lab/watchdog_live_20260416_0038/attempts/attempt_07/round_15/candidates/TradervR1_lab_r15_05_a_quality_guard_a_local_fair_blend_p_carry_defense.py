...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 39.6128593769,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 6.1371368023,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 3.0182116376,
    "BASE_QUOTE_EDGE": 5.751975059,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.0221962067,
    "BULLISH_IMBALANCE": 0.0722257636,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.6253983418,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0755971421,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.4921869775,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5832392145,
