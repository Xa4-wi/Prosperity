...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.7651859168,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.6290665084,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.3047908576,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.5107071024,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 6.5105593819,
    "MIN_QUOTE_EDGE": 2.9379955564,
    "TAKE_L3_SIZE": 16,
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 42.4947148975,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 7.8752211346,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.4007205162,
    "BASE_QUOTE_EDGE": 5.056648844,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.0894919911,
    "BULLISH_IMBALANCE": 0.0111142451,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.53418384,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.1341058905,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.2983949973,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.3922802351,
