...
- Composite score: `-74.5962`
- MC plausible mean delta: `458.3333`
- MC plausible p10 delta: `-2481.0000`
- MC win rate: `0.8333`
...
- Composite score: `-134.7272`
- MC plausible mean delta: `-45.1667`
- MC plausible p10 delta: `-2287.7500`
- MC win rate: `0.6667`
...
- ash_attack_tuning: mean_score=0.0 old=0.186 new=0.2
- ash_quality_guard: mean_score=-179.61 old=0.186 new=0.2
- ash_local_fair_blend: mean_score=-421.31 old=0.193 new=0.2
- pepper_entry_quality: mean_score=-116.56 old=0.227 new=0.215
- pepper_carry_defense: mean_score=-791.6 old=0.207 new=0.2
