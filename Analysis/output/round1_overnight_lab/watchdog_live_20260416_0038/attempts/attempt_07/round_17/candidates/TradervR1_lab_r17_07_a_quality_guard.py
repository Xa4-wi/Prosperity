...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.5234739425,
    "STABLE_MID_WEIGHT": 0.4765260575,
    "WALL_MID_BLEND": 0.3866886738,
    "LOCAL_MICRO_WEIGHT": 0.3129042741,
    "LOCAL_IMBALANCE_BIAS": 0.2338875193,
    "DEPTH_IMPACT_SCALE": 65.4108519673,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.102949834,
    "INVENTORY_CURVE": 1.4327186691,
    "BASE_EDGE": -1.0,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0,           # snap quote to existing order when within this
    "FRONT_SIZE": 21.8156995222,
    "BACK_SIZE": 3,
    "SOFT_LIMIT": 72.9292087691,           # reduce aggressiveness above this inventory
    ...
    "ADVERSE_IMBALANCE": 0.1946759722,
    "STRONG_IMBALANCE": 0.1817602907,
}
