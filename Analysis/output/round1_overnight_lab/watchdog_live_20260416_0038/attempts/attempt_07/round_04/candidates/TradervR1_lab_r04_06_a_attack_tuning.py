...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.5627249423,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.7078881163,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.8041533252,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 65.28392878,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 0.2633476231,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.4191388107,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 6.1851858412,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
