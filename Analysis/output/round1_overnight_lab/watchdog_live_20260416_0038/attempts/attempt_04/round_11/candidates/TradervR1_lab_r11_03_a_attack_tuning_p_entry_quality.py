...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.8242554223,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.9122935762,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.7299275834,
    "BACK_SIZE": 6.0,
    "SOFT_LIMIT": 67.7024147521,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.2906949556,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.8217516218,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.82530567,
    "MIN_QUOTE_EDGE": 1.9142994226,
    "TAKE_L3_SIZE": 16,
...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.6636985227,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.1465904948,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.6473542942,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.6560994836,
    "CHEAP_ACCUM_TARGET_BUFFER": 14,
}
