...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.5477492158,
    "STABLE_MID_WEIGHT": 0.4522507842,
    "WALL_MID_BLEND": 0.3961286073,
    "LOCAL_MICRO_WEIGHT": 0.3378783228,
    "LOCAL_IMBALANCE_BIAS": 0.0440836236,
    "DEPTH_IMPACT_SCALE": 36.0760883171,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.0984407569,
    "INVENTORY_CURVE": 1.3574964078,
    "BASE_EDGE": -1.2687681306,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.2247086935,           # snap quote to existing order when within this
    "FRONT_SIZE": 18.5447089251,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 63.5564932811,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.7006320502,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.0605563949,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 2.8612439995,
    "MIN_QUOTE_EDGE": 2.3355870753,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2994219696,
    "STRONG_IMBALANCE": 0.1675782157,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.415430752,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0237190106,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.5228832578,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5705006712,
