...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 1.4770358509,           # default passive quote edge
    "JOIN_EDGE": 2.2536387805,           # snap quote to existing order when within this
    "FRONT_SIZE": 15.3120799895,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 64.0571121945,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 1.5467388819,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 3.9766874895,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 6.6286393668,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2770819215,
