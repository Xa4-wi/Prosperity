...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 1.7948621434,           # default passive quote edge
    "JOIN_EDGE": 1.8463059705,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 1.4312223019,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 4.2502515759,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 7.1688829147,
    "TAKE_L3_SIZE": 16,
