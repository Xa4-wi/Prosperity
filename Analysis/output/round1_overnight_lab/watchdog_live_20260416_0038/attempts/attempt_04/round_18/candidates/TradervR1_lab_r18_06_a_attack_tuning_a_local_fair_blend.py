...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.5107367183,
    "STABLE_MID_WEIGHT": 0.4892632817,
    "WALL_MID_BLEND": 0.3031266707,
    "LOCAL_MICRO_WEIGHT": 0.3189443854,
    "LOCAL_IMBALANCE_BIAS": 0.1206296835,
    "DEPTH_IMPACT_SCALE": 54.3841638034,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1020715052,
    "INVENTORY_CURVE": 2.4590813445,
    "BASE_EDGE": 1.1881576634,           # default passive quote edge
    "JOIN_EDGE": 2.7723294767,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 2.2008611827,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 4.0001346617,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 9.1690929112,
    "TAKE_L3_SIZE": 16,
