...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 2.0192888805,           # default passive quote edge
    "JOIN_EDGE": 1.8674038186,           # snap quote to existing order when within this
    "FRONT_SIZE": 20.2170413343,
    "BACK_SIZE": 4,
    "SOFT_LIMIT": 71.3549659572,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 3.0,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 5.2705552016,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 7.4258452457,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1809115527,
