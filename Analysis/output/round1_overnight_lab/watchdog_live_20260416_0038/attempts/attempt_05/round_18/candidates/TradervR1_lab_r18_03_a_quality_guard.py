...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.5110512109,
    "STABLE_MID_WEIGHT": 0.4889487891,
    "WALL_MID_BLEND": 0.4447161157,
    "LOCAL_MICRO_WEIGHT": 0.3910165079,
    "LOCAL_IMBALANCE_BIAS": 0.35,
    "DEPTH_IMPACT_SCALE": 44.5823415779,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1290737882,
    "INVENTORY_CURVE": 1.3914869399,
    "BASE_EDGE": -1.0,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0,           # snap quote to existing order when within this
    "FRONT_SIZE": 16.986682631,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 71.8671163927,           # reduce aggressiveness above this inventory
    ...
    "ADVERSE_IMBALANCE": 0.2103916625,
    "STRONG_IMBALANCE": 0.1852328879,
}
