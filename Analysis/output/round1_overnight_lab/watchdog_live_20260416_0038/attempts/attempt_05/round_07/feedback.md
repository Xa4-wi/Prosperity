...
- Composite score: `3434.2655`
- MC plausible mean delta: `2912.5000`
- MC plausible p10 delta: `67.2500`
- MC win rate: `0.8333`
...
- Deterministic total: `290089.0000`
- Delta vs safe baseline: `2046.5000`
- Delta vs aggressive anchor: `244.5000`
- Composite score: `2421.1938`
- MC plausible mean delta: `1043.8333`
- MC plausible p10 delta: `-1708.0000`
- MC win rate: `0.8333`
...
- Composite score: `1403.1912`
- MC plausible mean delta: `-82.0833`
- MC plausible p10 delta: `-3883.0000`
- MC win rate: `0.6667`
...
- ash_attack_tuning: mean_score=807.97 old=0.198 new=0.271
- ash_quality_guard: mean_score=-314.72 old=0.177 new=0.2
- ash_local_fair_blend: mean_score=1580.93 old=0.245 new=0.38
- pepper_entry_quality: mean_score=-10.01 old=0.203 new=0.202
- pepper_carry_defense: mean_score=1403.19 old=0.177 new=0.274
