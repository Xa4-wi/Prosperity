...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.419530332,
    "STABLE_MID_WEIGHT": 0.580469668,
    "WALL_MID_BLEND": 0.2400624138,
    "LOCAL_MICRO_WEIGHT": 0.3820321637,
    "LOCAL_IMBALANCE_BIAS": 0.1779064094,
    "DEPTH_IMPACT_SCALE": 96.2138505238,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.0911703091,
    "INVENTORY_CURVE": 1.7096244993,
    "BASE_EDGE": -0.8998174252,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.2583562382,           # snap quote to existing order when within this
    "FRONT_SIZE": 22.0,
    "BACK_SIZE": 8,
    "SOFT_LIMIT": 55.7480755504,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 0.9505779734,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.5,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.0795962717,
    "MIN_QUOTE_EDGE": 1.8911892571,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2531508519,
    "STRONG_IMBALANCE": 0.1636071451,
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 37.424408381,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 7.802428188,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.8487065994,
    "BASE_QUOTE_EDGE": 4.9657370999,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 0.8105361939,
    "BULLISH_IMBALANCE": 0.0585727385,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.6357979959,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0783239263,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.7705816852,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.282908579,
    "CHEAP_ACCUM_TARGET_BUFFER": 24,
}
