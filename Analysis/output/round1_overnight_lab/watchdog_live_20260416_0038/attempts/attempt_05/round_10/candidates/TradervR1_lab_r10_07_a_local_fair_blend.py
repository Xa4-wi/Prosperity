...
DEFAULT_ASH_PARAMS = {
    ...
    "BASE_EDGE": -0.972705725,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.9223590138,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.2624824898,
    "BACK_SIZE": 3,
    "SOFT_LIMIT": 69.8640737628,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.2081009149,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.733293749,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 5.802022409,
    "MIN_QUOTE_EDGE": 2.30666382,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2134158142,
    "STRONG_IMBALANCE": 0.198740493,
}
