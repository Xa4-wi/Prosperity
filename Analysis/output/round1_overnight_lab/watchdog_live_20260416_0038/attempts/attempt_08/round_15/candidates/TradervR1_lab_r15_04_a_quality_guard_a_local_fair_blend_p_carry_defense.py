...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.6238789042,
    "STABLE_MID_WEIGHT": 0.3761210958,
    "WALL_MID_BLEND": 0.2676309105,
    "LOCAL_MICRO_WEIGHT": 0.5171640559,
    "LOCAL_IMBALANCE_BIAS": 0.1657234821,
    "DEPTH_IMPACT_SCALE": 58.2976795965,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1025140302,
    "INVENTORY_CURVE": 1.5218350113,
    "BASE_EDGE": -0.8206233273,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.4566926924,           # snap quote to existing order when within this
    "FRONT_SIZE": 16.370263574,
    "BACK_SIZE": 4,
    "SOFT_LIMIT": 63.5923982904,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.1609952219,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.8519483374,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.6632415129,
    "MIN_QUOTE_EDGE": 3.5031926366,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1812958246,
    "STRONG_IMBALANCE": 0.2079824705,
