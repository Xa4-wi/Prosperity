...
DEFAULT_ASH_PARAMS = {
    ...
    "JOIN_EDGE": 2.300908195,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 2.011773853,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 5.6177813387,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 10.0,
    "TAKE_L3_SIZE": 16,
