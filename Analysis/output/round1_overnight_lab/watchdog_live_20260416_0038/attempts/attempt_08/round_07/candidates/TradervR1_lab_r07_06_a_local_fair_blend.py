...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4483293525,
    "STABLE_MID_WEIGHT": 0.5516706475,
    "WALL_MID_BLEND": 0.4447753229,
    "LOCAL_MICRO_WEIGHT": 0.4190388806,
    "LOCAL_IMBALANCE_BIAS": 0.0650574381,
    "DEPTH_IMPACT_SCALE": 59.7358866993,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1506805985,
    "INVENTORY_CURVE": 1.8935732084,
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 38.7092047152,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 8.2839831653,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 3.0458375524,
    "BASE_QUOTE_EDGE": 5.8461450116,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 0.9412033932,
    "BULLISH_IMBALANCE": 0.0444861321,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.4641857835,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0707324073,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.3913891956,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.6189757785,
    "CHEAP_ACCUM_TARGET_BUFFER": 15,
}
