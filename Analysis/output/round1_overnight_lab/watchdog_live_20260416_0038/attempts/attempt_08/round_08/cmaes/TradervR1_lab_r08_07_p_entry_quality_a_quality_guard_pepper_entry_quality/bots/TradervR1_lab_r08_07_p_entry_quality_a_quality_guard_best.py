...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.5070471847,
    "STABLE_MID_WEIGHT": 0.4929528153,
    "WALL_MID_BLEND": 0.4264976216,
    "LOCAL_MICRO_WEIGHT": 0.2988451282,
    "LOCAL_IMBALANCE_BIAS": 0.0810797265,
    "DEPTH_IMPACT_SCALE": 51.8411857657,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1035331732,
    "INVENTORY_CURVE": 0.95045999,
    "BASE_EDGE": -1.0,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0,           # snap quote to existing order when within this
    "FRONT_SIZE": 15.7104204648,
    "BACK_SIZE": 7,
    "SOFT_LIMIT": 69.7496234784,           # reduce aggressiveness above this inventory
    ...
    "ADVERSE_IMBALANCE": 0.2035598871,
    "STRONG_IMBALANCE": 0.1507403545,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.667178566,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0012375624,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.6122531593,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5032437528,
    "CHEAP_ACCUM_TARGET_BUFFER": 21.0,
}
