...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4200124642,
    "STABLE_MID_WEIGHT": 0.5799875358,
    "WALL_MID_BLEND": 0.3874923088,
    "LOCAL_MICRO_WEIGHT": 0.3595449598,
    "LOCAL_IMBALANCE_BIAS": 0.1842127136,
    "DEPTH_IMPACT_SCALE": 41.6718338912,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.13676841,
    "INVENTORY_CURVE": 2.4671431627,
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 41.2173928342,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 8.5944592347,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.8186624883,
    "BASE_QUOTE_EDGE": 5.4677551415,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.1167498953,
    "BULLISH_IMBALANCE": 0.0049452959,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.6412386083,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0981450786,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.4567751128,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.7101885747,
