...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.2982861029,
    "STABLE_MID_WEIGHT": 0.7017138971,
    "WALL_MID_BLEND": 0.0978111908,
    "LOCAL_MICRO_WEIGHT": 0.5044273252,
    "LOCAL_IMBALANCE_BIAS": 0.1373774307,
    "DEPTH_IMPACT_SCALE": 35.9221676395,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.0722584866,
    "INVENTORY_CURVE": 4.1104856232,
    "BASE_EDGE": 0.5082463181,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.8833412055,           # snap quote to existing order when within this
    "FRONT_SIZE": 19.4534429198,
    "BACK_SIZE": 3,
    "SOFT_LIMIT": 72.3191096037,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.3595295912,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.4776964822,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.5683511794,
    "MIN_QUOTE_EDGE": 1.4800170026,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2502325978,
    "STRONG_IMBALANCE": 0.1258386252,
...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.5514589925,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0951103523,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.3651231753,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.7687045354,
