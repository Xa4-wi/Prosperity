...
- Composite score: `6841.9917`
- MC plausible mean delta: `4347.6667`
- MC plausible p10 delta: `3666.2500`
- MC win rate: `1.0000`
...
- Composite score: `2193.6238`
- MC plausible mean delta: `921.8333`
- MC plausible p10 delta: `-985.7500`
- MC win rate: `0.8333`
...
- ash_attack_tuning: mean_score=1382.08 old=0.19 new=0.295
- ash_quality_guard: mean_score=-225.46 old=0.195 new=0.2
- ash_local_fair_blend: mean_score=6841.99 old=0.234 new=0.363
- pepper_entry_quality: mean_score=1110.51 old=0.19 new=0.286
- pepper_carry_defense: mean_score=904.53 old=0.19 new=0.268
