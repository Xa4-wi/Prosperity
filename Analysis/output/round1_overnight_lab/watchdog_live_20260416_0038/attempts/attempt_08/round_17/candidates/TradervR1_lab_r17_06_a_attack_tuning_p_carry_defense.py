...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -1.424084692,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.5495302049,           # snap quote to existing order when within this
