...
DEFAULT_ASH_PARAMS = {
    ...
    "FRONT_SIZE": 14.9421134207,
    "BACK_SIZE": 7,
    "SOFT_LIMIT": 70.8640954844,           # reduce aggressiveness above this inventory
    ...
    "ADVERSE_IMBALANCE": 0.1602962946,
    "STRONG_IMBALANCE": 0.0967032215,
    "MARKOUT_ALPHA": 0.24,
    "BAD_MARKOUT": -0.90,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 40.9196370413,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 7.8299382914,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.9773787519,
    "BASE_QUOTE_EDGE": 5.0362063854,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 0.9829116651,
    "BULLISH_IMBALANCE": 0.0463303999,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.4841808323,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0662358942,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.3936227281,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.6129207339,
