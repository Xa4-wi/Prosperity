...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.9028457278,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.6777458249,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.466566731,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 67.9027733138,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.4860935491,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 3.0747587079,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 5.943712508,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
