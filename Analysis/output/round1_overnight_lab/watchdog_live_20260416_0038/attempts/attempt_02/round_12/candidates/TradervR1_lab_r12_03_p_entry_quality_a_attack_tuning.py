...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 1.9494112886,           # default passive quote edge
    "JOIN_EDGE": 3.0,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 2.269916471,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 5.374522303,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 8.3951461078,
    "TAKE_L3_SIZE": 16,
