...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.433468812,
    "STABLE_MID_WEIGHT": 0.566531188,
    "WALL_MID_BLEND": 0.322403706,
    "LOCAL_MICRO_WEIGHT": 0.3888812686,
    "LOCAL_IMBALANCE_BIAS": 0.248611084,
    "DEPTH_IMPACT_SCALE": 59.5533548654,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.0717183094,
    "INVENTORY_CURVE": 1.9965889077,
    "BASE_EDGE": -0.9396612129,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0589925122,           # snap quote to existing order when within this
    "FRONT_SIZE": 18.0153951015,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 73.6599876627,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 0.1675860457,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.6017593932,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.3547035355,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1409319115,
    "STRONG_IMBALANCE": 0.1645700417,
}
