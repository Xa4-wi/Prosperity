...
DEFAULT_ASH_PARAMS = {
    ...
    "BASE_EDGE": -0.680505211,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.2872177914,           # snap quote to existing order when within this
    "FRONT_SIZE": 15.3102730343,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 68.6786150789,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 0.6414992384,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.8393986128,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 2.0,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1768930291,
    "STRONG_IMBALANCE": 0.1993314477,
