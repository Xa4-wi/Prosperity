...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 1.6110742802,           # default passive quote edge
    "JOIN_EDGE": 2.7240294804,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 1.4692869342,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 4.4021199156,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 8.8561060039,
    "TAKE_L3_SIZE": 16,
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 39.0153142971,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 8.756448728,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.7192685477,
    "BASE_QUOTE_EDGE": 5.4572376573,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.3676743651,
    "BULLISH_IMBALANCE": 0.0610567192,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.5259651156,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.1477531345,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.3550637433,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.4931557927,
