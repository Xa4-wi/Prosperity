...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4757559423,
    "STABLE_MID_WEIGHT": 0.5242440577,
    "WALL_MID_BLEND": 0.2117951172,
    "LOCAL_MICRO_WEIGHT": 0.3712816304,
    "LOCAL_IMBALANCE_BIAS": 0.0854080099,
    "DEPTH_IMPACT_SCALE": 72.2885624132,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1069177542,
    "INVENTORY_CURVE": 3.0026389296,
    "BASE_EDGE": -1.4269753161,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.6064536202,           # snap quote to existing order when within this
    "FRONT_SIZE": 14.3941304702,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 74.7533104394,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.0878676889,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.5,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 6.2385553135,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2136698181,
    "STRONG_IMBALANCE": 0.1695290886,
