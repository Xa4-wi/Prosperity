...
DEFAULT_ASH_PARAMS = {
    ...
    "JOIN_EDGE": 1.7223536914,           # snap quote to existing order when within this
    "FRONT_SIZE": 16.4069752901,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 71.9400702138,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 0.5056392696,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 4.0681914411,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 8.8156788627,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1913487978,
    "STRONG_IMBALANCE": 0.1954271464,
}
