...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -1.5,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.4905993163,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.4337102664,
    "BACK_SIZE": 6.0,
    "SOFT_LIMIT": 64.8847911274,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.1882445832,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.665234229,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.837527487,
    "MIN_QUOTE_EDGE": 2.2682129614,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2222325559,
    "STRONG_IMBALANCE": 0.1568495021,
