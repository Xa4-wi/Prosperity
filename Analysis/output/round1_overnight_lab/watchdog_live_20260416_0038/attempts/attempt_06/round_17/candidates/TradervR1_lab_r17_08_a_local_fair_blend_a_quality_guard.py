...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.3234946321,
    "STABLE_MID_WEIGHT": 0.6765053679,
    "WALL_MID_BLEND": 0.4253577322,
    "LOCAL_MICRO_WEIGHT": 0.4485090158,
    "LOCAL_IMBALANCE_BIAS": 0.159993137,
    "DEPTH_IMPACT_SCALE": 51.8585859545,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.0934823507,
    "INVENTORY_CURVE": 2.5384145795,
    "BASE_EDGE": -1.1827198024,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.319861742,           # snap quote to existing order when within this
    "FRONT_SIZE": 14.3360951997,
    "BACK_SIZE": 4,
    "SOFT_LIMIT": 65.4128019555,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 0.2061339095,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 3.4041750297,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 5.2044212335,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2349000334,
    "STRONG_IMBALANCE": 0.1053868639,
