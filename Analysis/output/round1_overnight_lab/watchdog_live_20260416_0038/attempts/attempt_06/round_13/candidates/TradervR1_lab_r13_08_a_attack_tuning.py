...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.8460246681,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.872890002,           # snap quote to existing order when within this
    "FRONT_SIZE": 16.6041726101,
    "BACK_SIZE": 5.0,
    "SOFT_LIMIT": 69.1096630635,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.9166860933,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.1543603758,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.6801515875,
    "MIN_QUOTE_EDGE": 2.1434802951,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2073003301,
    "STRONG_IMBALANCE": 0.1646660342,
}
