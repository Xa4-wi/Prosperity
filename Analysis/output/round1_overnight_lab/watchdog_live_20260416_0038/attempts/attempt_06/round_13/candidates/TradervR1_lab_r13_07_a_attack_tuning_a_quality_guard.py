...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -1.1040245453,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.6298393718,           # snap quote to existing order when within this
    "FRONT_SIZE": 16.1274713919,
    "BACK_SIZE": 7,
    "SOFT_LIMIT": 75.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.5936659391,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.5,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.9910821561,
    "MIN_QUOTE_EDGE": 3.3640303132,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1789116246,
    "STRONG_IMBALANCE": 0.1914651881,
}
