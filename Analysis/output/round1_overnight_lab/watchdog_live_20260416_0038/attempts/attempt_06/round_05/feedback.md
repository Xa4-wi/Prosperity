...
- Deterministic total: `291701.0000`
- Delta vs safe baseline: `3658.5000`
- Delta vs aggressive anchor: `1856.5000`
- Composite score: `6072.1767`
- MC plausible mean delta: `4097.9167`
- MC plausible p10 delta: `3114.7500`
- MC win rate: `1.0000`
...
- Composite score: `1421.4928`
- MC plausible mean delta: `-31.4167`
- MC plausible p10 delta: `-3735.7500`
- MC win rate: `0.6667`
...
- ash_attack_tuning: mean_score=1382.08 old=0.207 new=0.322
- ash_quality_guard: mean_score=-225.46 old=0.224 new=0.201
- ash_local_fair_blend: mean_score=6072.18 old=0.215 new=0.334
- pepper_entry_quality: mean_score=1170.73 old=0.176 new=0.27
- pepper_carry_defense: mean_score=795.91 old=0.176 new=0.24
