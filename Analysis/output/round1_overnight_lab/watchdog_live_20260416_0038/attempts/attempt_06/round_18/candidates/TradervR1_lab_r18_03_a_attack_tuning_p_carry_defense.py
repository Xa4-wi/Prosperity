...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.2562032083,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.4121899457,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.4778233421,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.5123117736,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.4958596776,
    "MIN_QUOTE_EDGE": 2.1090456805,
    "TAKE_L3_SIZE": 16,
