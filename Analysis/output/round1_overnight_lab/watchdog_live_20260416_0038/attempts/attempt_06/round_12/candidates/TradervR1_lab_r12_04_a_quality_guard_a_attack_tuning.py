...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.7752866182,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0943341862,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.3879009217,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 66.5013301289,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.7629123353,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 3.6578513642,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.9023350937,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1538332098,
    "STRONG_IMBALANCE": 0.1346508104,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 43.1880245311,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 7.7973492333,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.8654281024,
    "BASE_QUOTE_EDGE": 5.5092626642,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.14366842,
    "BULLISH_IMBALANCE": 0.0855659727,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.5628391369,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.097317828,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.6095086125,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.3852861893,
