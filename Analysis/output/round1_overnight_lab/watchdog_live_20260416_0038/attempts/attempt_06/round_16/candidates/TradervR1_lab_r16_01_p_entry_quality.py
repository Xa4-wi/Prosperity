...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.8542698977,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0971403512,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.4055752761,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 64.109437239,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.3675418079,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.9497172182,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.8844368823,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2173122071,
    "STRONG_IMBALANCE": 0.1630653122,
...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.6242805567,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.4050209153,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5984000496,
    "CHEAP_ACCUM_TARGET_BUFFER": 19,
}
