...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -1.0041926442,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.7072330294,           # snap quote to existing order when within this
    "FRONT_SIZE": 18.4564741939,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 63.8041196212,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.0257465076,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.7345220771,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.5105509476,
    "MIN_QUOTE_EDGE": 1.6405255561,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.199992341,
    "STRONG_IMBALANCE": 0.1078992878,
