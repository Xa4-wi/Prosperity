...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 0.279364259,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.8545736949,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.1970689454,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.5681731934,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.3683477581,
    "MIN_QUOTE_EDGE": 1.4686220123,
    "TAKE_L3_SIZE": 16,
