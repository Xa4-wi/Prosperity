...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.5243976992,
    "STABLE_MID_WEIGHT": 0.4756023008,
    "WALL_MID_BLEND": 0.4150272507,
    "LOCAL_MICRO_WEIGHT": 0.5372085743,
    "LOCAL_IMBALANCE_BIAS": 0.0409000994,
    "DEPTH_IMPACT_SCALE": 57.398001039,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1119850722,
    "INVENTORY_CURVE": 2.5283216517,
    "BASE_EDGE": 0.4537760203,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.1733993958,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.1554918078,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.66816966,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.8640612476,
    "MIN_QUOTE_EDGE": 3.8861457635,
    "TAKE_L3_SIZE": 16,
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 49.0195184081,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 6.7810787042,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.8702685614,
    "BASE_QUOTE_EDGE": 5.6175102375,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 0.7945744346,
    "BULLISH_IMBALANCE": 0.0403438597,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.4928550158,
    "CHEAP_ACCUM_TAKE_PENALTY": 4.91063e-05,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.334342187,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.3869097093,
    "CHEAP_ACCUM_TARGET_BUFFER": 22,
}
