...
DEFAULT_ASH_PARAMS = {
    ...
    "JOIN_EDGE": 2.1506324378,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.1624132838,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 3.0098165921,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.7210585313,
    "MIN_QUOTE_EDGE": 2.7078770856,
    "TAKE_L3_SIZE": 16,
