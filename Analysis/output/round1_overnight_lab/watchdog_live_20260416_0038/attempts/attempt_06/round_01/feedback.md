...
- Composite score: `2505.5072`
- MC plausible mean delta: `1662.1667`
- MC plausible p10 delta: `-1020.2500`
- MC win rate: `0.8333`
...
- Deterministic total: `289132.5000`
- Delta vs safe baseline: `1090.0000`
- Delta vs aggressive anchor: `-712.0000`
- Composite score: `1169.2100`
...
- Composite score: `1016.4212`
- MC plausible mean delta: `-535.8333`
- MC plausible p10 delta: `-5313.5000`
- MC win rate: `0.6667`
...
- pepper_entry_quality: mean_score=832.56 old=0.2 new=0.276
- pepper_carry_defense: mean_score=1355.58 old=0.2 new=0.31
