...
- Composite score: `4687.5578`
- MC plausible mean delta: `1612.3333`
- MC plausible p10 delta: `-3824.0000`
- MC win rate: `0.6667`
...
- Composite score: `1628.1605`
- MC plausible mean delta: `386.0000`
- MC plausible p10 delta: `-3054.2500`
- MC win rate: `0.8333`
...
- ash_attack_tuning: mean_score=1382.08 old=0.223 new=0.346
- ash_quality_guard: mean_score=-225.46 old=0.188 new=0.2
- ash_local_fair_blend: mean_score=4687.56 old=0.225 new=0.348
- pepper_entry_quality: mean_score=1457.42 old=0.182 new=0.282
- pepper_carry_defense: mean_score=738.18 old=0.182 new=0.243
