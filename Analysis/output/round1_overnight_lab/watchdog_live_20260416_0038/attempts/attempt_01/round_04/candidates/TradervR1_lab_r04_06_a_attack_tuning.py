...
DEFAULT_ASH_PARAMS = {
    ...
    "BASE_EDGE": -0.934465145,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.1301143099,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 0.2494411722,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.4103187149,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 5.5232292181,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
