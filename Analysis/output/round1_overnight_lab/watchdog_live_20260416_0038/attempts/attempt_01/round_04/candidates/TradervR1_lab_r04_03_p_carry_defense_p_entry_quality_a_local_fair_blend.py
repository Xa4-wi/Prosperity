...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4685705108,
    "STABLE_MID_WEIGHT": 0.5314294892,
    "WALL_MID_BLEND": 0.3110139177,
    "LOCAL_MICRO_WEIGHT": 0.4558628118,
    "LOCAL_IMBALANCE_BIAS": 0.2131414761,
    "DEPTH_IMPACT_SCALE": 40.7065905082,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1238619525,
    "INVENTORY_CURVE": 2.4548949189,
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 38.0466104088,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 9.063234284,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.0796439822,
    "BASE_QUOTE_EDGE": 5.2447318392,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.2010929875,
    "BULLISH_IMBALANCE": 0.0347938788,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.5707882775,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.1630447471,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.2963726579,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5762424188,
