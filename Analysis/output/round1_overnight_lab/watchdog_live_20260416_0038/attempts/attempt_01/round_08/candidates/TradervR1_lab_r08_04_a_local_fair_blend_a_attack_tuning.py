...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4373790427,
    "STABLE_MID_WEIGHT": 0.5626209573,
    "WALL_MID_BLEND": 0.0559403907,
    "LOCAL_MICRO_WEIGHT": 0.4284066634,
    "LOCAL_IMBALANCE_BIAS": 0.268459685,
    "DEPTH_IMPACT_SCALE": 85.6035145161,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1185742065,
    "INVENTORY_CURVE": 2.9558700408,
    "BASE_EDGE": 2.5,           # default passive quote edge
    "JOIN_EDGE": 2.8787338165,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 1.0579830535,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 4.925434835,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 10.0,
    "TAKE_L3_SIZE": 16,
