...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 1.477163528,           # default passive quote edge
    "JOIN_EDGE": 2.0717052699,           # snap quote to existing order when within this
    "FRONT_SIZE": 20.6537472118,
    "BACK_SIZE": 4,
    "SOFT_LIMIT": 75.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 1.3471215144,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 5.4543839263,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 5.6750651791,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1894550509,
    "STRONG_IMBALANCE": 0.1689287164,
}
