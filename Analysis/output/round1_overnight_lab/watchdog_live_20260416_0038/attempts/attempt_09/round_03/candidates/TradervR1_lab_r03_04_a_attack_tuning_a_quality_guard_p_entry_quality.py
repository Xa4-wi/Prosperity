...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.3879587295,
    "STABLE_MID_WEIGHT": 0.6120412705,
    "WALL_MID_BLEND": 0.283740674,
    "LOCAL_MICRO_WEIGHT": 0.3944617647,
    "LOCAL_IMBALANCE_BIAS": 0.0,
    "DEPTH_IMPACT_SCALE": 56.3642331866,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.0943641856,
    "INVENTORY_CURVE": 1.5792877804,
    "BASE_EDGE": -0.6282597973,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.5777738064,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.466566731,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 67.9027733138,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.9860935491,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.5088200958,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 5.1619566231,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1496992046,
    "STRONG_IMBALANCE": 0.1065858709,
...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.4996658496,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.1018524857,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.3958457179,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.7434824415,
    "CHEAP_ACCUM_TARGET_BUFFER": 16,
}
