...
DEFAULT_ASH_PARAMS = {
    ...
    "BASE_EDGE": -0.2881976126,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.8479289764,           # snap quote to existing order when within this
    "FRONT_SIZE": 20.5135380295,
    "BACK_SIZE": 4,
    "SOFT_LIMIT": 65.6367888275,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 0.121867636,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.0998639397,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 5.1583599251,
    "MIN_QUOTE_EDGE": 2.8391368495,
    "TAKE_L3_SIZE": 16,
