...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 0.2394781875,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.108049899,           # snap quote to existing order when within this
    "FRONT_SIZE": 18.5447089251,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 63.5564932811,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.0601616414,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.0382528771,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 2.0,
    "MIN_QUOTE_EDGE": 2.0156040779,
    "TAKE_L3_SIZE": 16,
