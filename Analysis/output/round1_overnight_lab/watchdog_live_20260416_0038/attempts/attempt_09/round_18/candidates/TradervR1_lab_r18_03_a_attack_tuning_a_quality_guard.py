...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.5592572164,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.2558429939,           # snap quote to existing order when within this
    "FRONT_SIZE": 19.1312606258,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 69.6112206155,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.718867997,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.5749285725,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.6279026406,
    "MIN_QUOTE_EDGE": 1.9093342384,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1325290071,
    "STRONG_IMBALANCE": 0.1622457726,
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 49.7251217033,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 9.5769020559,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.8348144061,
    "BASE_QUOTE_EDGE": 5.2583309514,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.1196775033,
    "BULLISH_IMBALANCE": 0.073379985,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.5648534871,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.1348373042,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.3046927837,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.6024369855,
    "CHEAP_ACCUM_TARGET_BUFFER": 21,
}
