...
DEFAULT_ASH_PARAMS = {
    ...
    "BASE_EDGE": -1.2308081542,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.8344799451,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 0.3320200169,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.5,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 2.565776225,
    "MIN_QUOTE_EDGE": 2.2162593755,
    "TAKE_L3_SIZE": 16,
