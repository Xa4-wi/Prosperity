...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 44.1181012095,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 9.4349695137,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.5788461013,
    "BASE_QUOTE_EDGE": 4.9992863503,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 0.9698544733,
    "BULLISH_IMBALANCE": 0.0492842168,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.525981727,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0773459736,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.5929486062,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5788032622,
