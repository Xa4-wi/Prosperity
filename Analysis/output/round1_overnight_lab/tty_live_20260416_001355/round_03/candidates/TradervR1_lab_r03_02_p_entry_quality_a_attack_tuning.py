...
DEFAULT_ASH_PARAMS = {
    ...
    "BASE_EDGE": -1.4115381225,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.4558144563,           # snap quote to existing order when within this
    "FRONT_SIZE": 19.7594568609,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 69.8263433313,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.2671306191,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.0765895394,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.8487932701,
    "MIN_QUOTE_EDGE": 2.5017040397,
    "TAKE_L3_SIZE": 16,
