...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4105232801,
    "STABLE_MID_WEIGHT": 0.5894767199,
    "WALL_MID_BLEND": 0.2886872031,
    "LOCAL_MICRO_WEIGHT": 0.4032154612,
    "LOCAL_IMBALANCE_BIAS": 0.1701120053,
    "DEPTH_IMPACT_SCALE": 44.1980204145,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1035619015,
    "INVENTORY_CURVE": 1.8292258384,
    "BASE_EDGE": -1.0,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0,           # snap quote to existing order when within this
    "FRONT_SIZE": 15.7595108863,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 71.9335582363,           # reduce aggressiveness above this inventory
    ...
    "ADVERSE_IMBALANCE": 0.199519202,
    "STRONG_IMBALANCE": 0.2170218298,
}
