...
DEFAULT_ASH_PARAMS = {
    ...
    "BASE_EDGE": -1.0797215642,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.8437770913,           # snap quote to existing order when within this
    "FRONT_SIZE": 19.7594568609,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 69.8263433313,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.6527224134,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.2908502001,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 2.5947310333,
    "MIN_QUOTE_EDGE": 2.356732227,
    "TAKE_L3_SIZE": 16,
