...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4331894689,
    "STABLE_MID_WEIGHT": 0.5668105311,
    "WALL_MID_BLEND": 0.2005280513,
    "LOCAL_MICRO_WEIGHT": 0.4983951898,
    "LOCAL_IMBALANCE_BIAS": 0.1304823549,
    "DEPTH_IMPACT_SCALE": 53.5937152876,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1058302915,
    "INVENTORY_CURVE": 1.1051818989,
    "BASE_EDGE": -0.3955648159,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.350631917,           # snap quote to existing order when within this
    "FRONT_SIZE": 19.7594568609,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 69.8263433313,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.5,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.4674566732,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 2.0,
    "MIN_QUOTE_EDGE": 1.4,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1642501576,
    "STRONG_IMBALANCE": 0.1558885697,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 43.2595259654,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 6.852810197,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.5854903071,
    "BASE_QUOTE_EDGE": 5.4898893931,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 0.9809626603,
    "BULLISH_IMBALANCE": 0.0684735993,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.5699839455,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0567245293,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.6014422357,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5982001662,
