...
DEFAULT_ASH_PARAMS = {
    ...
    "BASE_EDGE": -0.762870782,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.1702775424,           # snap quote to existing order when within this
    "FRONT_SIZE": 21.1739437783,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 74.1527094347,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.6839061304,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.3560742525,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 2.667249917,
    "MIN_QUOTE_EDGE": 1.8571689881,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1555135714,
    "STRONG_IMBALANCE": 0.1700752595,
}
