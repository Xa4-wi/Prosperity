...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -1.3447515893,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.4580318764,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.7809779931,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 71.4968571768,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.2190991992,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.636969753,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 5.494647273,
    "MIN_QUOTE_EDGE": 2.0479114115,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.2165414328,
    "STRONG_IMBALANCE": 0.1439783148,
