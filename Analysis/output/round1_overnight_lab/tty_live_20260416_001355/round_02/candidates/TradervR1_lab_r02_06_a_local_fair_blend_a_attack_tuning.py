...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4774602965,
    "STABLE_MID_WEIGHT": 0.5225397035,
    "WALL_MID_BLEND": 0.3775987841,
    "LOCAL_MICRO_WEIGHT": 0.5101681487,
    "LOCAL_IMBALANCE_BIAS": 0.1225278776,
    "DEPTH_IMPACT_SCALE": 58.8652273018,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.0898575908,
    "INVENTORY_CURVE": 2.7184182307,
    "BASE_EDGE": -0.7812987558,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.1635539021,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.2474961181,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.8459121672,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.3089141769,
    "MIN_QUOTE_EDGE": 1.8314189273,
    "TAKE_L3_SIZE": 16,
