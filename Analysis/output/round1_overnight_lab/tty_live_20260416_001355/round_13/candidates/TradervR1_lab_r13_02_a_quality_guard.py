...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.676846933,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.2536848401,           # snap quote to existing order when within this
    "FRONT_SIZE": 16.6522027464,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.6785588222,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.5,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.2259739151,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.6743453867,
    "MIN_QUOTE_EDGE": 1.9064489933,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1811596518,
    "STRONG_IMBALANCE": 0.1444549187,
