...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4308596346,
    "STABLE_MID_WEIGHT": 0.5691403654,
    "WALL_MID_BLEND": 0.3800227477,
    "LOCAL_MICRO_WEIGHT": 0.454374407,
    "LOCAL_IMBALANCE_BIAS": 0.1865453545,
    "DEPTH_IMPACT_SCALE": 45.218282716,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1063740205,
    "INVENTORY_CURVE": 1.6814413436,
    "BASE_EDGE": -1.2490212279,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.2376745128,           # snap quote to existing order when within this
    "FRONT_SIZE": 18.3812069433,
    "BACK_SIZE": 7,
    "SOFT_LIMIT": 71.8592722827,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.4800250974,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.5973488218,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.8419811875,
    "MIN_QUOTE_EDGE": 2.1217953437,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1621016396,
    "STRONG_IMBALANCE": 0.1644631514,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 42.4110987926,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 7.4531069956,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.5604628556,
    "BASE_QUOTE_EDGE": 5.4543072434,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.0087108997,
    "BULLISH_IMBALANCE": 0.0583531007,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.6248436493,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0997887162,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.676526206,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.4634360947,
