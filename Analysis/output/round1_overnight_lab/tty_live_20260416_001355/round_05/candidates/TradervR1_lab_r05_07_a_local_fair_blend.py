...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4342245576,
    "STABLE_MID_WEIGHT": 0.5657754424,
    "WALL_MID_BLEND": 0.3333067925,
    "LOCAL_MICRO_WEIGHT": 0.6219234939,
    "LOCAL_IMBALANCE_BIAS": 0.1641980224,
    "DEPTH_IMPACT_SCALE": 62.2469634227,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.0984077628,
    "INVENTORY_CURVE": 1.5692268757,
    "BASE_EDGE": -0.6790653144,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.1245188334,           # snap quote to existing order when within this
    "FRONT_SIZE": 19.226259048,
    "BACK_SIZE": 7,
    "SOFT_LIMIT": 70.1635357943,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.6170409611,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.5386942581,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 2.4830992101,
    "MIN_QUOTE_EDGE": 2.1492208893,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.150716431,
    "STRONG_IMBALANCE": 0.1374314144,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 42.6628491051,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 7.3683588708,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.9552213858,
    "BASE_QUOTE_EDGE": 5.3699377886,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.1841494785,
    "BULLISH_IMBALANCE": 0.0981994148,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.6744606185,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.1941293919,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.6817352893,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5266544893,
