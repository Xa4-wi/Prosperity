...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.7696332699,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0878178285,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.3657016092,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.0272136164,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.6122175532,
    "MIN_QUOTE_EDGE": 1.8595054592,
    "TAKE_L3_SIZE": 16,
