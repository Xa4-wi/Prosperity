...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.6885896526,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 1.5788001583,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.7324869929,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 68.7033383143,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.1963427383,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 0.8299467512,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.6440263267,
    "MIN_QUOTE_EDGE": 1.5671124146,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1937460126,
    "STRONG_IMBALANCE": 0.1802957187,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.5557676711,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0621384499,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.4711422857,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5436176483,
