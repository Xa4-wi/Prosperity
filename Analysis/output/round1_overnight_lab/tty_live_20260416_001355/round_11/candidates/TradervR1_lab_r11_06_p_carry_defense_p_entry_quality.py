...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 46.9962818084,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 7.4036196037,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.718344081,
    "BASE_QUOTE_EDGE": 4.9704806043,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.0901435024,
    "BULLISH_IMBALANCE": 0.0363587545,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.577937601,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0781446543,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.5236150831,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5775752825,
