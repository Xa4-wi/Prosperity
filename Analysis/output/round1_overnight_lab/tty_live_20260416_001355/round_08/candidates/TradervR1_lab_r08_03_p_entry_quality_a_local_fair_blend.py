...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4673488245,
    "STABLE_MID_WEIGHT": 0.5326511755,
    "WALL_MID_BLEND": 0.3876315252,
    "LOCAL_MICRO_WEIGHT": 0.4825141512,
    "LOCAL_IMBALANCE_BIAS": 0.0983485414,
    "DEPTH_IMPACT_SCALE": 61.6154586086,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.0986944805,
    "INVENTORY_CURVE": 1.8567204815,
    "BASE_EDGE": -1.0,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0,           # snap quote to existing order when within this
    "FRONT_SIZE": 19.9171244794,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 70.8269181434,           # reduce aggressiveness above this inventory
    ...
    "ADVERSE_IMBALANCE": 0.180896711,
    "STRONG_IMBALANCE": 0.1629121459,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.5859712105,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0398351598,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.7120012713,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.3826675389,
