...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.3744959461,
    "STABLE_MID_WEIGHT": 0.6255040539,
    "WALL_MID_BLEND": 0.3613028111,
    "LOCAL_MICRO_WEIGHT": 0.4973451154,
    "LOCAL_IMBALANCE_BIAS": 0.1532499293,
    "DEPTH_IMPACT_SCALE": 45.2001462088,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.1086832089,
    "INVENTORY_CURVE": 2.0938635295,
    "BASE_EDGE": -1.4586867181,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.1757732808,           # snap quote to existing order when within this
    ...
    "TAKE_L1_EDGE": -1.5,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.1915213017,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 5.767427097,
    "MIN_QUOTE_EDGE": 1.7083341964,
    "TAKE_L3_SIZE": 16,
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 44.6460346164,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 9.5889968344,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 3.0128425946,
    "BASE_QUOTE_EDGE": 5.3653232912,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 0.9911853999,
    "BULLISH_IMBALANCE": 0.0520422164,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.5437581005,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0988320072,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.5003168762,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5368804631,
