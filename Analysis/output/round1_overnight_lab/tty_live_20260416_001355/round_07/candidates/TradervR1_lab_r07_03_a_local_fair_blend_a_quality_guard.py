...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4177802903,
    "STABLE_MID_WEIGHT": 0.5822197097,
    "WALL_MID_BLEND": 0.3855633091,
    "LOCAL_MICRO_WEIGHT": 0.5255226216,
    "LOCAL_IMBALANCE_BIAS": 0.2156415443,
    "DEPTH_IMPACT_SCALE": 76.0729067336,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.0992355517,
    "INVENTORY_CURVE": 2.0116422855,
    "BASE_EDGE": -1.0,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.5951093358,
    "BACK_SIZE": 6,
    ...
    "ADVERSE_IMBALANCE": 0.1923438034,
    "STRONG_IMBALANCE": 0.1499879245,
}
