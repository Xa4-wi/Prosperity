...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 1.9284323963,           # default passive quote edge
    "JOIN_EDGE": 2.1069669221,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.9490426927,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 69.6926033324,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 1.7316766532,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 4.9152796855,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 7.8828386839,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1790942753,
    "STRONG_IMBALANCE": 0.1611619279,
    "MARKOUT_ALPHA": 0.24,
    "BAD_MARKOUT": -0.90,
}
