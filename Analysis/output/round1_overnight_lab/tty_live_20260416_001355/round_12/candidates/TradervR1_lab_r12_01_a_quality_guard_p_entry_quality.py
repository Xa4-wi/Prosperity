...
DEFAULT_ASH_PARAMS = {
    ...
    "FRONT_SIZE": 17.3597236183,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.1537472599,           # reduce aggressiveness above this inventory
    ...
    "ADVERSE_IMBALANCE": 0.1952073485,
    "STRONG_IMBALANCE": 0.1808101447,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 43.3235594879,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 8.2237681756,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.7599039394,
    "BASE_QUOTE_EDGE": 5.7061262626,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 0.9990778307,
    "BULLISH_IMBALANCE": 0.0500387808,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.535073315,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0590939867,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.4224762543,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.6204331735,
