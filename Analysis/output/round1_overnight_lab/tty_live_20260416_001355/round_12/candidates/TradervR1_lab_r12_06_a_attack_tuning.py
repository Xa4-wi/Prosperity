...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 2.3135820043,           # default passive quote edge
    "JOIN_EDGE": 1.7000465181,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 2.0248752892,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 4.5488539682,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 7.8715139717,
    "TAKE_L3_SIZE": 16,
