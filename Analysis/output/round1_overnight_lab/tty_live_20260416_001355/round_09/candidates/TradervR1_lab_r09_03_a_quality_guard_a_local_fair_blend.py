...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.3774405466,
    "STABLE_MID_WEIGHT": 0.6225594534,
    "WALL_MID_BLEND": 0.3822581737,
    "LOCAL_MICRO_WEIGHT": 0.411334417,
    "LOCAL_IMBALANCE_BIAS": 0.1958826196,
    "DEPTH_IMPACT_SCALE": 52.9514962496,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.103050394,
    "INVENTORY_CURVE": 1.6398396111,
    "BASE_EDGE": -1.0,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0,           # snap quote to existing order when within this
    "FRONT_SIZE": 19.7626736375,
    "BACK_SIZE": 6,
    "SOFT_LIMIT": 71.7052859234,           # reduce aggressiveness above this inventory
    ...
    "ADVERSE_IMBALANCE": 0.1683770735,
    "STRONG_IMBALANCE": 0.1900718427,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 43.4567970568,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 8.9303155155,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 3.1329717475,
    "BASE_QUOTE_EDGE": 5.0766794565,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.0726530926,
    "BULLISH_IMBALANCE": 0.053945983,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.5708036751,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0548449139,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.4740292177,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.4823405957,
