...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 2.2591192528,           # default passive quote edge
    "JOIN_EDGE": 1.8935645239,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 2.0900791987,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 4.7175309281,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 7.8635203245,
    "TAKE_L3_SIZE": 16,
