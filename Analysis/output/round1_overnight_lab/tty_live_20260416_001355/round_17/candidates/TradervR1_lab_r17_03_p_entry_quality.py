...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4207732606,
    "STABLE_MID_WEIGHT": 0.5792267394,
    "WALL_MID_BLEND": 0.3449657993,
    "LOCAL_MICRO_WEIGHT": 0.4483669483,
    "LOCAL_IMBALANCE_BIAS": 0.1499204517,
    "DEPTH_IMPACT_SCALE": 61.6684729038,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.0964480349,
    "INVENTORY_CURVE": 1.9697973035,
    "BASE_EDGE": -0.9688274302,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0788799245,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.881674544,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.8726438556,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.0501179564,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.6403744648,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.9037118019,
    "MIN_QUOTE_EDGE": 2.0911626382,
    "TAKE_L3_SIZE": 16,
    # Toxic-book thresholds
    "ADVERSE_IMBALANCE": 0.1722092802,
    "STRONG_IMBALANCE": 0.1632402394,
}
...
DEFAULT_IPR_PARAMS = {
    ...
    "EARLY_LONG_BIAS": 42.420440805,         # extra target early in day (fades to 0 by 85%)
    "EDGE_TARGET_SCALE": 12.0,       # target += scale * (fair - mid)
    "ZSCORE_BUY_BONUS": 12.0,
    "ZSCORE_SELL_PENALTY": 7.3336327192,
    "MAX_LONG_TARGET": 76.0,
    "MAX_SHORT_TARGET": 20,
    "EARLY_ACCUM_END": 0.42,         # fraction of day where early accumulation ends
    # Execution
    "INVENTORY_SKEW": 0.078,
    "BASE_TAKE_EDGE": 2.7300534668,
    "BASE_QUOTE_EDGE": 5.2883389657,
    "SOFT_LIMIT": 52,
    "PASSIVE_FRONT_SIZE": 9,
    "PASSIVE_BACK_SIZE": 6,
    "PASSIVE_BUY_BUFFER": 18,
    "PASSIVE_SELL_BUFFER": 8,
    "OVEREXTENSION_Z": 1.125021666,
    "BULLISH_IMBALANCE": 0.0226267597,
    # Cheaper accumulation overlay
    "CHEAP_ACCUM_END": 0.5832719711,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0664044721,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.4970953017,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.536393725,
