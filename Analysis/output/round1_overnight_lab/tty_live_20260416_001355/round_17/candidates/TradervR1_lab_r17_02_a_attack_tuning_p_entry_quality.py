...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 1.97018682,           # default passive quote edge
    "JOIN_EDGE": 2.1023404788,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 1.9741194757,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 5.0355501951,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 8.0525828097,
    "TAKE_L3_SIZE": 16,
...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.5704112712,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.0719457453,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.5063743771,
    "CHEAP_ACCUM_FRONT_SIZE_BONUS": 1,
    "CHEAP_ACCUM_BACK_SIZE_BONUS": 1,
    "CHEAP_ACCUM_Z_RELAX": -0.5876239268,
