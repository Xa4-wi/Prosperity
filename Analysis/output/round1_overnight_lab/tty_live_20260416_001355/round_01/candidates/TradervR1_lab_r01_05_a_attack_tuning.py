...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": -0.5878615245,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.3077621221,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -0.8524031808,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 2.7654175079,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 3.8690151137,
    "MIN_QUOTE_EDGE": 2.3880043083,
    "TAKE_L3_SIZE": 16,
