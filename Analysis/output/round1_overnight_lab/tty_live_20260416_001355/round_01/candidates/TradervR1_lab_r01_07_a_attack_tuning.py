...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 1.724521523,           # default passive quote edge
    "JOIN_EDGE": 2.0398672727,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": 2.3454989227,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 3.5026929115,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 6.4809470139,
    "TAKE_L3_SIZE": 16,
