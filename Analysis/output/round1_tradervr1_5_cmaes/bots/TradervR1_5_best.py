...
class AshCoatedOsmiumBot:
    ...
    IMBALANCE_FAIR_WEIGHT = 3.4866713733
    MICRO_FAIR_WEIGHT = 0.35
    INVENTORY_SKEW = 0.0940270728
    BASE_EDGE = 7.0931846105
    JOIN_EDGE = 2.0
    FRONT_ORDER_SIZE = 8
    BACK_ORDER_SIZE = 5
    SOFT_LIMIT = 28
...
class IntarianPepperRootBot:
    DRIFT_PER_TIMESTAMP = 0.001023362
    RESIDUAL_ALPHA = 0.1050571779
    SPREAD_ALPHA = 0.08
    BASE_CARRY = 12.2905860116
    EARLY_LONG_BIAS = 31.9955762028
    EDGE_TARGET_SCALE = 11.9282377144
    ZSCORE_BUY_BONUS = 12.0
    ZSCORE_SELL_PENALTY = 9.0338574834
    MAX_LONG_TARGET = 68
    MAX_SHORT_TARGET = 20
    INVENTORY_SKEW = 0.0830389499
    BASE_TAKE_EDGE = 1.072419258
    BASE_QUOTE_EDGE = 2.424258598
    SOFT_LIMIT = 52
    PASSIVE_FRONT_SIZE = 9
    PASSIVE_BACK_SIZE = 6
    MAX_TAKE_SIZE = 16
    BULLISH_IMBALANCE = 0.0373296841
    OVEREXTENSION_Z = 1.1650841493
    EARLY_ACCUM_END = 0.42
    LOOKAHEAD_BONUS = 4.0520675871
    PASSIVE_BUY_BUFFER = 18
    PASSIVE_SELL_BUFFER = 7.8252919594
