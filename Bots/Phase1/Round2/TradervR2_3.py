...
DEFAULT_ASH_PARAMS = {
    ...
    # Official-style hypothesis:
    # keep Pepper as the heavy lifter, and make Osmium access monetization
    # more selective so extra access does not bleed through lower-quality Ash fills.
    "ACCESS_JOIN_EDGE_BONUS": 0.12,
    "ACCESS_FRONT_BONUS": 1,
    "ACCESS_BACK_BONUS": 0,
    "ACCESS_TAKE_RELIEF": 0.05,
    "ACCESS_SWEEP_LEVELS": 2,
    "ACCESS_SWEEP_EDGE_STEP": 0.20,
    "ACCESS_SIGNAL_MIN": 0.30,
    "ACCESS_CONVICTION_MIN": 0.55,
