...
class AshCoatedOsmiumTrader:
    ...
    def _mode(
        ...
        inventory_risk = (bid_toxic and pos > 4) or (ask_toxic and pos < -4)
        market_risk = book.spread_val >= float(self.p["WIDE_SPREAD"]) and (bid_toxic or ask_toxic)
        if inventory_risk or market_risk:
            return "toxic_defense"
