...
# Archetype: anchored MM with toxicity cancel/reinsert behavior (Lehalle-Mounjid)
DEFAULT_ASH_PARAMS = {
    "ENABLED": True,
...
class AshCoatedOsmiumTrader:
    """
    Anchored MM with stronger toxicity retreat and reinsert logic.
    """
    ...
    def build_orders(self, state: TradingState) -> List[Order]:
        ...
        if bid_toxic:
            front_buy -= reinsert
        elif book.imbalance > strong and book.micro > book.mid:
