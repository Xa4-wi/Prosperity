...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_SKEW": 0.120001775,    # reservation -= skew * position
    "BASE_EDGE": 1.9860904111,           # default passive quote edge
    "JOIN_EDGE": 2.0,           # snap quote to existing order when within this
    "FRONT_SIZE": 15.9704564834,
    "BACK_SIZE": 5,
    ...
    "ADVERSE_IMBALANCE": 0.200981197,
    "STRONG_IMBALANCE": 0.16,
    "TOXIC_RETREAT_SIZE": 0.7009471244,
    "TOXIC_RETREAT_EDGE": 0.5140452765,
    "DISLOCATION_EDGE": 6.0781343194,
    "DISLOCATION_BONUS_SIZE": 3,
}
