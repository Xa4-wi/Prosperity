...
class TomatoesTrader(BaseProductTrader):
    ...
    def execution_plan(
        ...
        if regime == "volatile" and abs(gap) <= 4 and abs(breakout_score) < 0.8:
            plan["allow_buy_passive"] = False
            plan["allow_sell_passive"] = False
        return plan
    ...
    def passive_size(self, side: str, regime: str, volatility: float, execution_plan: Optional[Dict[str, object]] = None) -> int:
    ...
    def allow_passive(self, side: str, regime: str, execution_plan: Optional[Dict[str, object]] = None) -> bool:
        position = self.projected_position()
