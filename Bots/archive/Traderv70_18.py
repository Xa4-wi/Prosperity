...
DEFAULT_TOMATOES_PARAMS = {
    ...
    "GRAVITY_CAP": 1.40,
    "SOFT_ADVERSE_EDGE": 1.20,
    "SOFT_ADVERSE_BREAKOUT": 0.90,
    "SOFT_ADVERSE_POSITION": 14,
    "SOFT_ADVERSE_UNWIND_BONUS": 0.10,
...
class TomatoesTrader(BaseProductTrader):
    ...
    def take_orders(
        ...
        if (
            ...
            and (
                predicted_edge >= self.SOFT_ADVERSE_EDGE
                or breakout_score >= self.SOFT_ADVERSE_BREAKOUT
            )
        ):
            buy_threshold += self.SOFT_ADVERSE_UNWIND_BONUS
        ...
        if (
            ...
            sell_threshold -= self.SOFT_ADVERSE_UNWIND_BONUS
    ...
    def run(self) -> List[Order]:
        ...
        position = self.projected_position()
        if (
            position <= -int(self.SOFT_ADVERSE_POSITION)
            and (
                predicted_edge >= self.SOFT_ADVERSE_EDGE
                or breakout_score >= self.SOFT_ADVERSE_BREAKOUT
            )
