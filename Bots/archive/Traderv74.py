...
DEFAULT_TOMATOES_PARAMS = {
    ...
    "FUSED_DEPTH_FAST_WEIGHT": 0.50,
    "FUSED_DEPTH_SLOW_WEIGHT": 0.38,
    "FUSED_DEPTH_MEMORY_WEIGHT": 0.12,
    "FUSED_DEPTH_BLEND_WEIGHT": 0.08,
    "FUSED_DEPTH_FAIR_WEIGHT": 0.05,
    "CHANNEL_WINDOW": 18,
    ...
    def fused_depth_signal(self, slow_depth_alpha: float) -> Dict[str, float]:
        ...
        if top_alpha * slow_depth_alpha < 0:
            ...
            if agreement < 0.35:
                ...
                fused += math.copysign(0.06 * agreement * abs(memory_component), fused if fused != 0 else top_alpha)
