...
class AshCoatedOsmiumTrader:
    ...
    def _smoothed_toxicity_levels(
        ...
        if raw_bid_level == 2:
            bid_score = min(4.0, bid_score * 0.76 + 1.38)
        elif raw_bid_level == 1:
            bid_score = min(4.0, bid_score * 0.81 + 0.78)
        else:
            if prev_bid_level == 2:
                bid_score = max(0.0, bid_score * 0.82 - 0.02)
        ...
        if raw_ask_level == 2:
            ask_score = min(4.0, ask_score * 0.76 + 1.38)
        elif raw_ask_level == 1:
            ask_score = min(4.0, ask_score * 0.81 + 0.78)
        else:
            if prev_ask_level == 2:
                ask_score = max(0.0, ask_score * 0.82 - 0.02)
        ...
        if (
            ...
            or bid_score >= 2.85
            or (prev_bid_level == 2 and bid_score >= 1.60)
        ):
            bid_level = 2
        ...
        if (
            ...
            or ask_score >= 2.85
            or (prev_ask_level == 2 and ask_score >= 1.60)
        ):
            ask_level = 2
