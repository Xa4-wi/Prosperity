...
DEFAULT_ASH_PARAMS = {
    ...
    "INVENTORY_CURVE": 2.2,
    "BASE_EDGE": 1.0,           # one tick more aggressive than the trunk
...
DEFAULT_IPR_PARAMS = {
    ...
    "BASE_TAKE_EDGE": 1.7678379562,
    "BASE_QUOTE_EDGE": 4.351603402,
    "SOFT_LIMIT": 52,
...
class AshCoatedOsmiumTrader:
    ...
    def build_orders(self, state: TradingState) -> List[Order]:
        ...
        buy_qe = max(3.8, buy_qe)
        sell_qe = max(3.8, sell_qe)
