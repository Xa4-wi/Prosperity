...
DEFAULT_ASH_PARAMS = {
    ...
    "FILL_PENALTY_WEIGHT": 0.55,
    "FILL_PENALTY_TOXIC": 0.18,
    "FILL_PENALTY_CONF": 0.22,
    "QUOTE_MIN_NET_EDGE": 0.15,
...
DEFAULT_IPR_PARAMS = {
    ...
    "SHOCK_ALPHA": 0.22,
    "SHOCK_AGGR_BUY": -1.35,
    "SHOCK_PASSIVE_BUY": 0.05,
    "SHOCK_STOP_BUY": 0.75,
    "SHOCK_TAKE_PENALTY": 0.30,
    "SHOCK_QUOTE_PENALTY": 0.55,
}
...
class AshCoatedOsmiumTrader:
    ...
    def build_orders(self, state: TradingState, memory: dict) -> Tuple[List[Order], dict]:
        ...
        if ask_toxic:
            ask_size_mult -= 0.22
        bid_size_mult -= 0.18 * min(1.0, buy_penalty)
        ask_size_mult -= 0.18 * min(1.0, sell_penalty)
