...
DEFAULT_IPR_PARAMS = {
    ...
    "CHEAP_ACCUM_END": 0.62,
    "CHEAP_ACCUM_TAKE_PENALTY": 0.18,
    "CHEAP_ACCUM_QUOTE_EDGE_BONUS": 0.60,
...
class IntarianPepperRootTrader:
    ...
    def build_orders(self, state: TradingState, memory: dict) -> Tuple[List[Order], dict]:
        ...
        if reservation - book.best_ask >= buy_te and mgr.buy_cap > 0 and not passive_first_early:
