...
DEFAULT_ASH_PARAMS = {
    ...
    "ANCHOR_WEIGHT": 0.4263210641,
    "STABLE_MID_WEIGHT": 0.5736789359,
    "WALL_MID_BLEND": 0.3578649789,
    "LOCAL_MICRO_WEIGHT": 0.4285262528,
    "LOCAL_IMBALANCE_BIAS": 0.1646902863,
    "DEPTH_IMPACT_SCALE": 50.8646096959,
    "DEPTH_FLOOR": 8.0,
    "INVENTORY_SKEW": 0.099212006,
    "INVENTORY_CURVE": 2.1139057367,
    "BASE_EDGE": -0.8679308442,          # strongest Osmium aggression tested so far
    "JOIN_EDGE": 2.0415900328,           # snap quote to existing order when within this
    "FRONT_SIZE": 17.52842512,
    "BACK_SIZE": 5,
    "SOFT_LIMIT": 70.0,           # reduce aggressiveness above this inventory
    # Tiered take: [(min_edge, qty_clip), ...]
    "TAKE_L1_EDGE": -1.4280175019,
    "TAKE_L1_SIZE": 6,
    "TAKE_L2_EDGE": 1.5295000165,
    "TAKE_L2_SIZE": 10,
    "TAKE_L3_EDGE": 4.6605878285,
    "MIN_QUOTE_EDGE": 1.9473931437,
    "TAKE_L3_SIZE": 16,
