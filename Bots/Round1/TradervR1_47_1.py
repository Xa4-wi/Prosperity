...
DEFAULT_ASH_PARAMS = {
    ...
    # Lightweight fill-quality brake
    "MARKOUT_ALPHA": 0.22,
    "SOFT_BAD_MARKOUT": -0.75,
    "HARD_BAD_MARKOUT": -1.20,
    "MARKOUT_EDGE_PENALTY": 0.18,
    "MARKOUT_SIZE_PENALTY": 0.15,
}
...
class AshCoatedOsmiumTrader:
    ...
    def _infer_fill_quality(self, book: Book, position: int, ash_state: dict) -> Tuple[float, float]:
