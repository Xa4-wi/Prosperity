...
class AshCoatedOsmiumBot:
    ...
    IMBALANCE_FAIR_WEIGHT = 3.4866713732667933
    MICRO_FAIR_WEIGHT = 0.35
    INVENTORY_SKEW = 0.09402707280456833
    BASE_EDGE = 7.093184610517301
    JOIN_EDGE = 2.0
    FRONT_ORDER_SIZE = 8
    BACK_ORDER_SIZE = 5
    SOFT_LIMIT = 28
...
class IntarianPepperRootBot:
    DRIFT_PER_TIMESTAMP = 0.0010233620234569563
    RESIDUAL_ALPHA = 0.1050571779118872
    SPREAD_ALPHA = 0.08
    BASE_CARRY = 12.290586011615789
    EARLY_LONG_BIAS = 31.99557620280861
    EDGE_TARGET_SCALE = 11.92823771443657
    ZSCORE_BUY_BONUS = 12.0
    ZSCORE_SELL_PENALTY = 9.033857483407488
    MAX_LONG_TARGET = 68
    MAX_SHORT_TARGET = 20
    INVENTORY_SKEW = 0.08303894994193817
    BASE_TAKE_EDGE = 1.0724192580068626
    BASE_QUOTE_EDGE = 2.4242585979702955
    SOFT_LIMIT = 52
    PASSIVE_FRONT_SIZE = 9
    PASSIVE_BACK_SIZE = 6
    MAX_TAKE_SIZE = 16
    BULLISH_IMBALANCE = 0.03732968412097508
    OVEREXTENSION_Z = 1.1650841493352775
    EARLY_ACCUM_END = 0.42
    LOOKAHEAD_BONUS = 4.052067587082764
    PASSIVE_BUY_BUFFER = 18
    PASSIVE_SELL_BUFFER = 7.825291959391047
