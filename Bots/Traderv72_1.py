...
DEFAULT_TOMATOES_PARAMS = {
    ...
    "FUSED_DEPTH_MEMORY_WEIGHT": 0.24,
    "FUSED_DEPTH_BLEND_WEIGHT": 0.22,
    "FUSED_DEPTH_FAIR_WEIGHT": 0.10,
    "CHANNEL_WINDOW": 18,
...
class TomatoesTrader(BaseProductTrader):
    ...
    def run(self) -> List[Order]:
        ...
        provisional_edge = (
            ...
            + (0.20 * pressure_bias)
            + (self.FUSED_DEPTH_BLEND_WEIGHT * fused_depth["net"])
