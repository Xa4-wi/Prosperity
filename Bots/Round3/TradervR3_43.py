...
class Trader:
    ...
    def _trade_voucher(self, product: str, state: TradingState, voucher_ctx: dict, risk_ctx: dict) -> List[Order]:
        ...
        elif pos > 0 and abs(iv_residual) < 0.55 * resid_threshold and bb is not None and bb >= fair - (clear_edge + 0.20):
        ...
        elif pos < 0 and abs(iv_residual) < 0.55 * resid_threshold and ba is not None and ba <= fair + (clear_edge + 0.20):
