...
class Trader:
    ...
    - Step 4: trade vouchers as a strip with pair-first bias, partial hedge, and
      lower middle-strike risk budgets
    - Step 5: rebalance Hydrogel and Velvet fair construction toward the
    ...
    def _trade_voucher(self, product: str, state: TradingState, voucher_ctx: dict, risk_ctx: dict) -> List[Order]:
        ...
        soft_limit = 90 if middle_band else 130
        per_strike_cap = 110 if not middle_band else 90
