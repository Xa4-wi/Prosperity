            ...
            try:
                ...
                if velvet_ctx is not None:
                    ...
                    for product, strike in SMALL_VOUCHER_STRIKES.items():
                        ...
                        bs_target = 0.35 * limit * math.tanh(mispricing / max(2.0, edge_scale))
                        ...
                        result[product] = self._trade_targeted(
                            ...
                            take_bias=0.10 * math.tanh(mispricing / max(2.0, edge_scale)) * edge_scale,
                            quote_bias=0.08 * math.tanh(mispricing / max(2.0, edge_scale)) * edge_scale,
