...
class Trader:
    ...
    def _trade_voucher(
        ...
        if strike == 5200:
            if pair_edge_5200_5300 > 0.012:
                sell_threshold = max(0.014, resid_threshold - 0.004)
                soft_limit = 42
            elif pair_edge_5200_5300 < -0.012:
                sell_threshold = resid_threshold + 0.006
        elif strike == 5300:
            if pair_edge_5200_5300 < -0.012:
                sell_threshold = max(0.028, resid_threshold - 0.004)
                soft_limit = 28
            elif pair_edge_5200_5300 > 0.012:
                sell_threshold = resid_threshold + 0.008
