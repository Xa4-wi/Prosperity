...
# ---------------------------------------------------------------------------
# v46 — v32 pair-layer base plus moneyness buckets
#
# Starts from the 240k+ v32 pair-layer winner and reintroduces the v35
# delta/moneyness threshold layer for the single-voucher engine.
# ---------------------------------------------------------------------------
