...
# ---------------------------------------------------------------------------
# v45 — Mark67/Mark49 VELVET fair overlay only
#
# Starts from v42 and adds the strongest VELVET trader-ID signal:
# Mark67 buys and Mark49 sells. It does not block quotes or force targets.
# ---------------------------------------------------------------------------
