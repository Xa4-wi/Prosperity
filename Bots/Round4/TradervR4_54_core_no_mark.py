...
# ---------------------------------------------------------------------------
# v54 — core no-Mark Round 4 bot
#
# Radical cleanup from v53. Keeps only the core non-Mark components:
...
class Trader:
    ...
    def _trade_deep_itm_voucher(
        ...
        spread = float(ba - bb)
        rich_threshold = max(0.8, 0.30 * spread)
        cheap_threshold = max(1.0, 0.35 * spread)
