...
# ---------------------------------------------------------------------------
# v44 — VELVET trader-ID fair overlay only
#
# Starts from v42 and adds only the capturable part of the VELVET trader-ID
# signal: a small fair-value shift. It does not block quotes or force targets.
# ---------------------------------------------------------------------------
...
class Trader:
    ...
    def _velvet_overlay(self, state: TradingState, memory: dict) -> float:
        """Detect Olivia plus VELVET trader-ID rebound pattern."""
        ...
        return olivia_bias + 2.0 * id_score
