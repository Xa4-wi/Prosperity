...
# ---------------------------------------------------------------------------
# v47 — deep-ITM voucher time-value engine
#
# Starts from v46 and routes VEV_4000/4500 through an intrinsic/time-value
# residual engine with a small Mark 38/14 execution filter.
# ---------------------------------------------------------------------------
