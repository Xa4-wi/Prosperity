...
# ---------------------------------------------------------------------------
# v42 — clean no-named-Mark base
#
# This is the promoted zero trader-ID branch from v24. It keeps the simple
# anchor market-making core, dynamic voucher TTE, OTM voucher buy block,
# pair-edge threshold shaping, and Velvet voucher-delta hedge.
#
# Named trader-ID overlays are intentionally not used here.
# ---------------------------------------------------------------------------
